...
const API_KEY = "AIzaSyAi4IygzaZgMgYhiJF8qq680ZPN9o_I4h4";
...
try {
    if (API_KEY) {
        ...
        // Using gemini-1.5-flash which is often faster/cheaper, or fallback to pro
        // But let's stick to gemini-pro as in original code or updated one
...
export const generateAvatarResponse = async (userInput, category = "general") => {
    ...
    try {
        ...
        else if (category === "celebration") prompt = "Celebrate with me! I did a great job!";
        else if (category === "thinking") prompt = "Say something to show you are thinking hard about a problem.";
        else if (category === "help") prompt = "Offer to help me with my task.";
